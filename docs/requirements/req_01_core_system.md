...
*   **Componenti UI:**
    *   [LoginPage.jsx](src/components/Auth/LoginPage.jsx) (interfaccia di login/registrazione)
    *   [PlayerManager.jsx](src/components/GM/PlayerManager.jsx) (gestione giocatori e abilitazioni)
    *   [CompanyManager.jsx](src/components/GM/CompanyManager.jsx) (gestione compagnie)
    *   [CampaignManager.jsx](src/components/GM/CampaignManager.jsx) (gestione campagne)
    *   [PlayerDashboard.jsx](src/components/Player/PlayerDashboard.jsx) (dashboard dei giocatori)
    *   [PlayerCharacterSheet.jsx](src/components/Player/PlayerCharacterSheet.jsx) (scheda PG sola lettura)
    *   [App.jsx](src/App.jsx) (routing principale, gestione roster, duplicazione e import/export)
*   **Servizi e Stato Globale:**
    *   [AuthContext.jsx](src/contexts/AuthContext.jsx) (stato utente, persistenza della sessione, auto-GM al primo login)
    *   [playerService.js](src/services/playerService.js) (integrazione Firestore/Cloud Functions per i giocatori)
    *   [characterService.js](src/services/characterService.js) (persistenza PG e roster)
    *   [companyService.js](src/services/companyService.js) (CRUD compagnie)
    *   [campaignService.js](src/services/campaignService.js) (CRUD campagne)
